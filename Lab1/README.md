...
## Contents
- [แสดงผลตามตัวอย่าง 1](#แสดงผลตามตัวอย่าง-1)
- [แสดงผลตามตัวอย่าง 2](#แสดงผลตามตัวอย่าง-2)
- [แสดงผลตามตัวอย่าง 3](#แสดงผลตามตัวอย่าง-3)
- [แสดงผลตามตัวอย่าง 5](#แสดงผลตามตัวอย่าง-5)
- [ให้แสดงผลลัพธ์การพิมพ์ตามรูป](#ให้แสดงผลลัพธ์การพิมพ์ตามรูป)
---
## แสดงผลตามตัวอย่าง 1
Task :
```c
...
## ให้แสดงผลลัพธ์การพิมพ์ตามรูป
Task :
```c
แสดงผลตามตัวอย่าง

มีจำนวน 6 บรรทัด
บรรทัดแรก แสดง 1234567890 จำนวน 7 ครั้ง
บรรทัดที่สอง แสดง * จำนวน 9 ตัวอักษรดังตัวอย่าง
